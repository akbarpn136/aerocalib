...
export function InfoUmum() {
    return <div class="flex h-screen">
        <div class="py-8 px-4 m-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            <A href="/info" class="mt-14 inline-flex justify-between items-center p-1 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
                <span class="hidden sm:flex text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 me-3">
                ...
                <span class="text-sm font-medium p-2 sm:p-0">Yuk mampir, untuk mengenal tentang aplikasi ini</span>
