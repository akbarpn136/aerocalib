...
import { For, Show, Switch, Match, onMount, useContext, createSignal, createResource } from "solid-js"

import SkeletonKegiatan from "./skeletonkegiatan"
import { InfoUmumBox } from "../../components/info"
...
export default function DaftarKegiatan() {
    ...
    return <Switch>
        <Match when={keg.loading}>
            <SkeletonKegiatan />
        </Match>

        <Match when={state.kegiatan.length == 0}>
            <InfoUmumBox pesan="Kegiatan tidak ditemukan." />
        </Match>
