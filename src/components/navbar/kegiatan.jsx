...
import { createSignal, useContext, onMount } from "solid-js"
...
export default function TambahKegiatan() {
    ...
    let refModal
    const onModalKegiatanShow = () => {
        const modal = new Modal(refModal)

        modal.show()
    }

    const onModalKegiatanHide = () => {
        const modal = new Modal(refModal)
    ...
    const onFormKegiatanSubmit = async (e) => {
        ...
        if (error) {
            ...
            const kegiatan = data[0]

            onModalKegiatanHide()
            setState("kegiatan", [kegiatan, ...state.kegiatan])
    ...
    return <>
        ...
        <div id="modal-kegiatan" ref={refModal} tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button
                            ...
                            onClick={onModalKegiatanHide}
                            data-modal-hide="modal-kegiatan"
                        >
